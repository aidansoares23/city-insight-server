...
// //
// // What it does:
// // - Fetches CA city population + median gross rent from the US Census ACS API
// // - Upserts city_metrics docs with fields this script owns: population + medianGrossRent
// // - Recomputes livability for those cities
// //
// // Notes:
// // - This does NOT write safetyScore (owned by syncSafetyFromCsv.js)
// // - Census returns arrays; we map them into objects with debug logs
...
// // Minimal city config
// // -----------------------------
// // You can keep manual values for fallback, but this script will overwrite from ACS when available.
// // (This is also a clean way to only update the cities you care about.)
// const CITY_IDS = [
//   "san-francisco-ca",
//   "san-jose-ca",
//   "los-angeles-ca",
...
// function buildPatch(cityId, next) {
//   return {
//     cityId,
//     population: toNumOrNull(next?.population),
//     medianGrossRent: toNumOrNull(next?.medianGrossRent),
...
//   // 3) Write city_metrics
//   console.log("\n--- Firestore Writes: city_metrics ---");
...
//     const patch = buildPatch(cityId, row);
//     console.log("Writing patch:", cityId, patch);
